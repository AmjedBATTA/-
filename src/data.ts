...
export const ECOSYSTEM_SERVICES: EcosystemService[] = [
  {
    id: 'b2b',
    titleAr: 'انوار الحسن B2B',
    titleEn: 'ANWAR AL-HASSAN B2B',
    badge: 'المنصة الأم',
  ...
  {
    id: 'plus',
    titleAr: 'انوار الحسن بلس +',
    titleEn: 'ANWAR AL-HASSAN Plus',
  ...
  {
    id: 'market',
    titleAr: 'انوار الحسن ماركت',
    titleEn: 'ANWAR AL-HASSAN Market',
  ...
  {
    id: 'nod',
    titleAr: 'انوار الحسن نود',
    titleEn: 'ANWAR AL-HASSAN Nod',
  ...
  {
    id: 'pay',
    titleAr: 'انوار الحسن باي',
    titleEn: 'ANWAR AL-HASSAN Pay',
  ...
  {
    id: 'offer',
    titleAr: 'انوار الحسن أوفير (الشراء الجماعي)',
    titleEn: 'ANWAR AL-HASSAN Offer',
    badge: 'الخصومات الكبرى',
    description: 'تقنية الشراء التعاوني الجماعي، حيث تدمج انوار الحسن طلبات مئات الصيدليات الصغيرة لتشكيل طلب ضخم موحد، مما يؤهلهم للحصول على خصومات حصرية (بونص) وأسعار جملة منافسة.',
    iconName: 'ReceiptPercent',
    color: 'rose'
  },
  {
    id: '360',
    titleAr: 'انوار الحسن 360',
    titleEn: 'ANWAR AL-HASSAN 360',
    badge: 'بوابة المريض والصيدلية',
    description: 'تطبيق موجه للمرضى يتيح لهم البحث عن الوصفات ونواقص الأدوية وربطهم بأقرب صيدلية تستخدم منصة انوار الحسن لضمان توفر الدواء وتسهيل عملية الحجز والاستلام.',
    iconName: 'ShieldPlus',
    color: 'indigo'
  }
];
...
export const FAQS_DATA: FAQItem[] = [
  {
    ...
    answer: 'يجب أن تكون صيدلياً مجازاً وتمتلك إجازة ممارسة مهنة سارية صادرة عن نقابة صيادلة العراق. عند التسجيل عبر التطبيق، ستقوم برفع صورة الهوية أو صورة الإجازة لتتحقق منها إدارة انوار الحسن وتفعل حسابك خلال ساعات معدودة لتبدأ بالتسوق الفوري.'
  },
  {
    id: 'faq2',
    question: 'هل توجد عمولات أو رسوم إضافية تضعها انوار الحسن على الصيدليات؟',
    answer: 'لا، تطبيق انوار الحسن مجاني تماماً للصيدليات ولا يفرض أي زيادات أو رسوم فوق أسعار المذاخر الحقيقية. الأسعار المتاحة داخل التطبيق هي تماماً نفس الأسعار الرسمية والمعلنة الصادرة من مذاخر وشركات الأدوية شريكة المنصة.'
  },
  {
    id: 'faq3',
    question: 'كيف تتم عملية توصيل الأدوية الطلبية من انوار الحسن؟',
    answer: 'تتم عملية التوصيل واللوجستيات من خلال سيارات المذاخر العلمية المعتمدة ومستودعات الأدوية نفسها، أو عبر الأسطول الخاص بانوار الحسن المبرد وفقاً لشروط التخزين الدوائي لضمان وصول شحنتك سليمة ومبردة وبأقصر وقت.'
  },
  {
    id: 'faq4',
  ...
  },
  {
    ...
    answer: 'نعم، انوار الحسن تدعم الشحن والتوصيل البيني بين المحافظات. يمكنك تصفح المذاخر المتوفرة في محافظتك أو البحث عن المذاخر في المحافظات الأخرى التي تقدم خدمات الشحن إلى محافظتك بكل يسر وعبر بوابات الحساب المالي الموحد.'
  }
];
