  ...
  return (
    <AnimatePresence>
      {showUpdate && (
        ...
        >
          <div className="bg-white border border-primary-200 rounded-2xl shadow-2xl shadow-primary-100 p-4 flex items-center gap-3">
        ...
        >
          <div className="bg-white border border-slate-200 rounded-2xl shadow-2xl shadow-slate-100 p-4">
            <button
              ...
              className="absolute top-3 left-3 p-1 text-slate-500 hover:text-slate-600 transition-colors"
            >
              <X size={14} />
            </button>
            ...
            <button
              ...
              className="w-full bg-primary-600 hover:bg-primary-700 text-white text-sm font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2 transition-colors"
            >
              <Download size={16} />
              تثبيت التطبيق
            </button>
