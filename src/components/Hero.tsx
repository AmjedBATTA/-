          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <p className="text-lg text-slate-600 font-medium max-w-2xl leading-relaxed">
                كبسولة تربط آلاف الصيدليات والمذاخر العلمية ومستودعات الأدوية بمختلف المحافظات العراقية. تصفح، اطلب وباشر التحصيل المالي وإدارة نواقص صيدليتك في منصة سحابية واحدة مجانية وسريعة للغاية.
              </p>
            </motion.div>
